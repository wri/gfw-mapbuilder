export default {
  ...
  logoUrl:
    'https://cod.forest-atlas.org/system/site_settings/images/000/000/034/original/drc1.png?1487331314',
  logoLinkUrl: 'https://cod.forest-atlas.org',
  printServiceUrl:
    'https://gis.forest-atlas.org/server/rest/services/cod/ExportWebMap/GPServer/Export%20Web%20Map',
  narrative:
    "\u003cp\u003eCette carte représante l'affectation des terres en République Démocratique du Congo. Elle est crée par le Ministère de l'Environnement et Déloppement Durable (MEDD) avec l'appui de World Resources Institute (WRI).\u003c/p\u003e\u003cp\u003e\u003ci\u003eMEDD, WRI\u003c/i\u003e\u003c/p\u003e",
  ...
  alternativeNarrative:
    '\u003cp\u003eThis map shows the land allocation in the Democratic Republic of Congo. It is created by the Ministry of Environment,\u0026nbsp; and Sustainable Development (MEDD) with the support of the World Resources Institute (WRI).\u003c/p\u003e\u003cp\u003e\u003ci\u003eMEDD, WRI\u003c/i\u003e\u003c/p\u003e',
  ...
  analysisModules: [
    ...
    },
    {
      ...
      params: [{ name: 'layer', value: 'ifl2000' }],
      uiParams: [
        {
          inputType: 'rangeSlider',
          startParamName: 'period',
    ...
    },
    {
      ...
      params: [{ name: 'layer', value: 'gfw-landcover-2000' }],
      uiParams: [
        {
          inputType: 'rangeSlider',
          startParamName: 'period',
    ...
    },
    {
      ...
      uiParams: 'none',
      params: [{ name: 'layer', value: 'gfw-landcover-2015' }]
    }
  ],
  layerPanel: {
