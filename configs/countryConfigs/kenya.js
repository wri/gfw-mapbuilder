export default {
  webmap: '605ede6c10614fd0afc7b36c41e8306b',
  title: 'Kenya Water Towers Atlas',
  subtitle: 'The Status of Cherangany Water Tower ',
  webmapMenuName: 'Water Towers Layers - Cherangany',
  logoUrl: 'https://watertowers.go.ke/wp-content/uploads/2019/04/Web-logo.jpg',
  logoLinkUrl: 'https://www.gfw-mapbuilder.org/',
  printServiceUrl:
    'https://gis.forest-atlas.org/server/rest/services/ken/KWTA_ExportWebMap/GPServer/Export%20Web%20Map',
  narrative:
    '\u003cp\u003eThis map shows an overview of Cherangany\u0026nbsp; Water Tower\u0026nbsp;\u003cbr\u003e\u003c/p\u003e',
      ...
      layers: [
        {
          ...
          type: 'dynamic',
          url:
            'https://gis.forest-atlas.org/server/rest/services/ken/overlay_layers/MapServer',
          layerIds: [1],
          label: {
            en: 'County Boundaries'
          }
        },
        {
          order: 2,
        ...
        },
        {
          ...
          type: 'dynamic',
          url:
            'https://gis.forest-atlas.org/server/rest/services/ken/restoration_potential/MapServer',
          layerIds: [7],
          label: {
            en: 'Combined Restoration Potential'
          }
        }
      ]
    },
