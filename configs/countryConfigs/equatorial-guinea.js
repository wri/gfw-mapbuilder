export default {
  webmap: '7b12642b79ff4237924004f5c7f46c1f',
  title: 'Atlas Forestal de la República de Guinea Ecuatorial',
  subtitle: 'Ministerio de Agricultura y Bosques',
  webmapMenuName: 'Uso de la tierra',
  logoUrl: 'https://assets.forest-atlas.org/gnq/img/indefor-logo.png',
  logoLinkUrl: 'https://gnq.forest-atlas.org/',
  printServiceUrl:
    'https://gis.forest-atlas.org/server/rest/services/gnq/ExportWebMap/GPServer/Export%20Web%20Map',
  narrative: '',
  includeSubscribeButton: true,
  sharinghost: 'https://www.arcgis.com',
  analyticsCode: 'UA-62288390-13',
  iso: 'GNQ',
  language: 'es',
  useAlternativeLanguage: true,
  alternativeLanguage: 'en',
  alternativeWebmap: 'db231dee5dd5425685c24e48418e7b99',
  alternativeLanguageTitle: 'Forest Atlas of Equatorial Guinea',
  alternativeLanguageSubtitle: 'Ministry of Agriculture and Forestry',
