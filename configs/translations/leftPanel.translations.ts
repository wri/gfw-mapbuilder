export const analysisContent = {
  en: {
    ...
    uploadShapefileTitle: 'Upload shapefile',
    enterCoordsTitle: 'Enter Coordinates for your shape',
  ...
  az: {
    ...
    uploadShapefileTitle: 'Shapefile yükləyin',
    enterCoordsTitle: 'Formanız üçün koordinatları daxil edin',
    ...
    overlappingShapeDirections: [
      ...
      'Birinci formanı seçin',
      'Data Tab altındakı Analizə Əlavə et üzərinə klikləyin',
      'İkinci formanı seçin',
      'Data Tab altındakı Analizə Əlavə et üzərinə klikləyin',
      'Təhlil düyməsini basın',
    ],
    overlappingShapeButton: 'Seçimə başlayın',
  },
  nl: {
    analyzeExistingShapeTitle: 'Analyze a shape on the map',
    ...
    uploadShapefileTitle: 'Shapefile uploaden',
    enterCoordsTitle: 'Coördinaten voor uw vorm invoeren',
    ...
    overlappingShapeDirections: [
      ...
      'Selecteer de eerste vorm',
      'Klik op Toevoegen aan analyse onder tabblad Gegevens',
      'Selecteer de tweede vorm',
      'Klik op Toevoegen aan analyse onder tabblad Gegevens',
      'Klik op de knop Analyseren',
    ],
    overlappingShapeButton: 'Begin met selecteren',
  },
  hy: {
    analyzeExistingShapeTitle: 'Analyze a shape on the map',
    analyzeExistingShapeDirections: [
    ...
    uploadShapefileTitle: 'Վերբեռնեք Shapefile',
    enterCoordsTitle: 'Մուտքագրեք կոորդինատները ձեր ձևի համար',
    drawButton: 'Նկարել',
    ...
    overlappingShapeDirections: [
      ...
      'Ընտրեք առաջին ձևը',
      'Կտտացրեք «Ավելացնել վերլուծությանը» Տվյալների ներդիրի տակ',
      'Ընտրեք երկրորդ ձևը',
      'Կտտացրեք «Ավելացնել վերլուծությանը» Տվյալների ներդիրի տակ',
      'Սեղմեք վերլուծել կոճակը',
    ],
    overlappingShapeButton: 'Սկսեք ընտրել',
  },
  ka: {
    ...
    uploadShapefileTitle: 'ატვირთეთ Shapefile',
    enterCoordsTitle: 'შეიყვანეთ კოორდინატები თქვენი ფორმისთვის',
    ...
    overlappingShapeDirections: [
      ...
      'აირჩიეთ პირველი ფორმა',
      'დააჭირეთ ანალიზს დამატებას მონაცემთა ჩანართში',
      'აირჩიეთ მეორე ფორმა',
      'დააჭირეთ ანალიზს დამატებას მონაცემთა ჩანართში',
      'დააჭირეთ ანალიზის ღილაკს',
    ],
  ...
  fr: {
    ...
    uploadShapefileTitle: 'Télécharger le fichier de forme',
    enterCoordsTitle: 'Saisissez les coordonnées de votre forme',
    ...
    overlappingShapeDirections: [
      ...
      'Sélectionner la première forme',
      "Cliquer sur Ajouter à l'analyse sous l'onglet Données",
      'Sélectionnez la deuxième forme',
      "Cliquer sur Ajouter à l'analyse sous l'onglet Données",
      'Cliquez sur le bouton Analyser',
    ],
    overlappingShapeButton: 'Commencer à sélectionner',
  },
  es: {
    ...
    uploadShapefileTitle: 'Cargar Shapefile',
    enterCoordsTitle: 'Introduzca las coordenadas de su área',
    ...
    overlappingShapeDirections: [
      ...
      'Haga clic en Añadir al análisis en la pestaña Datos',
      'Seleccione el segundo objeto',
      'aga clic en Añadir al análisis en la pestaña Datos',
      'Haga clic en el botón Analizar',
    ],
    overlappingShapeButton: 'Empezar a seleccionar',
  },
  pt: {
    ...
    uploadShapefileTitle: 'Carregar ficheiro de forma',
    enterCoordsTitle: 'Introduza as coordenadas para a sua forma',
    ...
    overlappingShapeDirections: [
      ...
      'Seleccione a primeira forma',
      'Clique em Adicionar à análise em Data Tab',
      'Seleccione a segunda forma',
      'Clique em Adicionar à análise em Data Tab',
      'Clique no botão de análise',
    ],
    overlappingShapeButton: 'Comece a seleccionar',
  },
  id: {
    analyzeExistingShapeTitle: 'Analyze a shape on the map',
    analyzeExistingShapeDirections: [
    ...
    analyzeYourShapeFirstDirection: ['Choose the draw tool ', ' in the toolbox'],
    analyzeYourShapeDirections: ['Draw a shape anywhere on the map', 'Select the shape to run the analysis'],
    uploadShapefileTitle: 'Unggah Shapefile',
    enterCoordsTitle: 'Masukkan Koordinat untuk bentuk Anda',
    drawButton: 'Start drawing',
    ...
    overlappingShapeDirections: [
      ...
      'Pilih bentuk pertama',
      'Klik Tambahkan ke Analisis di bawah Tab Data',
      'Pilih bentuk kedua',
      'Klik Tambahkan ke Analisis di bawah Tab Data',
      'Klik pada tombol analisis',
    ],
    overlappingShapeButton: 'Mulai memilih',
  },
  zh: {
    ...
    uploadShapefileTitle: '上传形状文件',
    enterCoordsTitle: '为你的形状输入坐标',
    drawButton: '开始绘画',
