...
export const bannerContent = {
  en: {
    text: 'The Trees in Mosaic Landscapes dataset1 will be deprecated as of February 2024. Please use our new Tropical Tree Cover dataset instead. Find out more at',
  ...
  nl: {
    text: 'De dataset Trees in Mosaic Landscapes1 wordt beëindigd vanaf februari 2024. Gebruik in plaats daarvan onze nieuwe Tropical Tree Cover-dataset. Lees meer op',
    linkUrlText: 'Bomen vervangen in mozaïeklandschappen - MapBuilder',
  },
  hy: {
    text: '«Ծառերը խճանկարային լանդշաֆտներում» տվյալների հավաքածուն1 կհնացվի 2024 թվականի փետրվարից: Փոխարենը օգտագործեք մեր նոր Տրոպիկական ծառերի ծածկույթի տվյալների հավաքածուն: Իմացեք ավելին այստեղ',
