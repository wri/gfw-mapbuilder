...
export const LAYER_IDS = {
  ...
  TREE_COVER_HEIGHT: 'TREE_COVER_HEIGHT',
  CARBON_SEQ: 'CARBON_SEQ',
  FOREST_CARBON_GROSS_REMOVALS: 'FOREST_CARBON_GROSS_REMOVALS',
  FOREST_CARBON_GROSS_EMISSIONS: 'FOREST_CARBON_GROSS_EMISSIONS',
  FOREST_CARBON_NET_FLUX: 'FOREST_CARBON_NET_FLUX',
