export default {
  webmap: '2b990a56346c4d20950128132771d63b',
  title: 'Atlas Forestier de la République Centrafricaine',
  subtitle: 'Ministère des Eaux, Forêts, Chasse et Pêche',
  webmapMenuName: 'Affectation des terres',
  logoUrl: 'https://assets.forest-atlas.org/caf/img/car-logo.png',
  logoLinkUrl: 'https://caf.forest-atlas.org/',
  printServiceUrl:
    'https://gis.forest-atlas.org/server/rest/services/caf/ExportWebMap/GPServer/Export%20Web%20Map',
  narrative: '',
  includeSubscribeButton: true,
  sharinghost: 'https://www.arcgis.com',
  analyticsCode: 'UA-62288390-12',
  iso: 'CAF',
  language: 'fr',
  useAlternativeLanguage: true,
  alternativeLanguage: 'en',
  alternativeWebmap: 'ae990df7d79b4b198f3f5376cbfe1c9c',
  alternativeLanguageTitle: 'Forest Atlas of Central African Republic',
  alternativeLanguageSubtitle:
    'Ministry of Water, Forests, Hunting and Fishing',
