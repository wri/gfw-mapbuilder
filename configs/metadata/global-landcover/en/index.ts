export const en = {
  ...
  lean_more: 'http://maps.elie.ucl.ac.be/CCI/viewer/download/ESACCI-LC-Ph2-PUGv2_2.0.pdf',
  content: [
    {
      label: 'Function',
      value: '<p>Shows the global distribution of land cover in 2015</p>',
    },
    {
    ...
    {
      label: 'License',
      value: '<p><a href="http://maps.elie.ucl.ac.be/CCI/viewer/download.php">Terms of Use</a></p>',
    },
    ...
    {
      label: 'Source',
      value: '<p>© ESA Climate Change Initiative - Land Cover led by UCLouvain (2017)</p>',
    },
    {
      label: 'Amazon Link',
      value: 'http://gfw2-data.s3.amazonaws.com/forest_cover/zip/global_landcover_2015.tif',
    },
    {
      label: 'Resolution',
      value: '<p>300 × 300 meters</p>',
    },
    {
