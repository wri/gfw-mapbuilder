export default {
  //- NOTE: New Forest Atlas 2.0 Options, These are the raw values coming from ArcGIS Online from
    ...
    subtitle: 'Atlas Forestal Interactivo de México',
    logoUrl: 'http://bosquesabiertos.org.mx/images/BA-logo-hdr-map.png',
    logoLinkUrl: 'http://bosquesabiertos.org.mx',
    ...
    narrative: '<p><strong>Bosques Abiertos, el Atlas Forestal Interactivo de México.</strong> <br/> <br/>Consulta las autorizaciones de gestión forestal (cambio de uso de suelo, aprovechamientos de recursos forestales, plantaciones forestales comerciales, entre otros) otorgadas por la Semarnat. <br/><br/> Evalúa la pérdida o ganancia de cobertura forestal en estos o en otros territorios, así como alertas de incendios y tipo de cobertura forestal.</p>',
    ...
    gladAlerts: true,
    terraIAlerts: true,
    webmapMenuName: 'Gestión Forestal',
