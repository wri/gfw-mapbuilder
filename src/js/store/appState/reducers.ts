...
const initialState: AppState = {
  ...
  leftPanel: {
    ...
    gladStart: subYears(new Date(), 2).toLocaleDateString(),
    gladEnd: new Date().toString(),
    glad2Start: subYears(new Date(), 2).toLocaleDateString(),
    glad2End: new Date().toString(),
    raddAlertStart: subYears(new Date(), 2).toLocaleDateString(),
