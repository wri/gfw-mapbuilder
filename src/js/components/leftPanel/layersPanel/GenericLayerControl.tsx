    ...
    switch (id) {
      ...
      /*case 'TEST_LAYER':
        return (
          <TimeSlider
            layerID={id}
            defaultMarks={defaultMarks} //date values being pushed into slider
            min={2001} //minimum date
            max={2021} //maximum date
            defaultValue={[2001, 2021]} // default date value array
            steps={1} // value to be added or subtracted on each step of the slider
            included={true} // if true it will be a continuous value interval, otherwise independent value
          />
        );*/
      case 'DRY_SPELLS':
