...
const createLayers = function createLayers (layerPanel, activeLayers, language, params) {
    ...
    landMapFeatureLayerMap[landmarkLayers.INDIGENOUS_DOCUMENTED] = ['indigenous_DocumentedFeature0', 'indigenous_DocumentedFeature1'];
    landMapFeatureLayerMap[landmarkLayers.INDIGENOUS_NOT_DOCUMENTED] = ['indigenous_NotDocumentedFeature0', 'indigenous_NotDocumentedFeature1'];
    landMapFeatureLayerMap[landmarkLayers.INDIGENOUS_FORMAL_CLAIM] = ['indigenous_FormalClaimFeature0', 'indigenous_FormalClaimFeature1'];
    landMapFeatureLayerMap[landmarkLayers.INDIGENOUS_CUSTOMARY] = ['indigenous_CustomaryFeature0', 'indigenous_CustomaryFeature1'];
    landMapFeatureLayerMap[landmarkLayers.COMMUNITY_DOCUMENTED] = ['community_DocumentedFeature0', 'community_DocumentedFeature1'];
    landMapFeatureLayerMap[landmarkLayers.COMMUNITY_NOT_DOCUMENTED] = ['community_NotDocumentedFeature0', 'community_NotDocumentedFeature1'];
    landMapFeatureLayerMap[landmarkLayers.COMMUNITY_FORMAL_CLAIM] = ['community_FormalClaimFeature0', 'community_FormalClaimFeature1'];
    landMapFeatureLayerMap[landmarkLayers.COMMUNITY_CUSTOMARY] = ['community_CustomaryFeature0', 'community_CustomaryFeature1'];
...
const runAnalysis = function runAnalysis (params, feature) {
  ...
  const layerConf = appUtils.getObject(lcdLayers, 'id', layerKeys.LAND_COVER);
