...
const printReport = function printReport() {
  console.log('print report');
};

const getReportInfo = function getReportInfo() {
  console.log('get report info');
};

const shareReport = function shareReport() {
